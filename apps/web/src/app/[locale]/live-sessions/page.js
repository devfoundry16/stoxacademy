            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-500 font-medium mb-0.5">{t('date')}</p>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-500 font-medium mb-0.5">{t('time')}</p>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-500 font-medium mb-0.5">{t('participants')}</p>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-linear-to-br from-green-50 to-emerald-50 rounded-lg">
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-500 font-medium mb-0.5">{t('price')}</p>
                ...
                <div className="flex items-center justify-center gap-2 mb-4 p-2 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <span className="text-sm font-medium text-gray-700">{t('minutesDuration', { duration: session.duration })}</span>
                </div>
                ...
                >
                    ...
                    <span>{session.status === 'live' ? t('joinLiveSession') : t('viewDetails')}</span>
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-50">
                <Header />
                <LoadingSpinner message={t('loadingSessions')} fullScreen />
            </div>
        );
    }
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
                    <div className="text-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full mb-6">
                            <Video size={20} />
                            <span className="text-sm font-semibold">{t('interactiveLearning')}</span>
                        </div>
                        <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">
                            {t('liveSessions')}
                        </h1>
                        <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
                            {t('joinInteractiveSessions')}
                        </p>
                    </div>
                </div>
            </motion.div>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-sm font-medium text-gray-600">{t('status.scheduled')}</p>
                    </motion.div>
                    <motion.div
                        variants={staggerItem}
                        whileHover={{ y: -4 }}
                    ...
                    >
                        ...
                        <p className="text-sm font-medium text-gray-600">{t('status.liveNow')}</p>
                    </motion.div>
                    <motion.div
                        variants={staggerItem}
                        whileHover={{ y: -4 }}
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                    <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <label className="text-sm font-semibold text-gray-900">{t('filterByStatus')}</label>
                        </div>
                        <motion.div
                            variants={staggerContainer}
                            initial="initial"
            ...
            >
                {sessions.length === 0 ? (
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 mb-3">{t('noSessionsFound')}</h3>
                        <p className="text-gray-600 text-lg">{t('checkBackLater')}</p>
                    </motion.div>
                ) : (
                    <motion.div
                        variants={staggerContainer}
