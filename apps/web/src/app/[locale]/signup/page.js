...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || t('common.failedToSignUp'));
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.error || t('common.failedToSignUpWithGoogle'));
      setLoading(false);
    }
  };
  ...
  return (
    <motion.div
      ...
      animate="animate"
      variants={fadeInUp}
      className="min-h-screen flex items-center justify-center bg-linear-to-br from-blue-50 to-indigo-100 px-4 py-12"
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          <p className="text-gray-600">{t('signup.joinStoxAcademy')}</p>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              minLength={6}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
              placeholder={t('signup.atLeast6Characters')}
            />
          </div>
        ...
        >
          ...
          >
            ...
            <span className="text-gray-700 font-medium">{t('common.signUpWithGoogle')}</span>
          </motion.button>
        </motion.div>
